...
import ProductInformationDetails from './pages/productInformationDetails/productInformationDetails.P';
    ...
    <div className="App">
      {loading ? <Loading fadeOut={fadeOut} />  :<>
        ...
        <Routes>
          ...
          <Route path="/products/:id" element={<ProductInformationDetails/>} />
